...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Hemmel"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Hemmel "       # Response box header label
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "Hemmel",
            "welcome": "Welcome to Hemmel! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Hemmel ",
            "prompt_symbol": "❯",
